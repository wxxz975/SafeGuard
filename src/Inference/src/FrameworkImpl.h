...
namespace Inference
{
    ...
    public:
        ...
        inline void SetMetadata(std::shared_ptr<Base::ModelMetadata> metadata) { m_metadata = metadata; };

        inline std::shared_ptr<Base::ModelMetadata> GetMetadata() { return m_metadata; };
